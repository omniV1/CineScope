...
public partial class Program
{
    ...
    private static void ConfigureMongoDb()
    {
        ...
        {
            Console.WriteLine($"Error configuring MongoDB serialization: {ex.Message}");
        }
    }
    ...
    public static async Task Main(string[] args)
    {
        ...
        /// </summary>
        builder.Services.AddSingleton<IMovieCacheService, MovieCacheService>();
        ...
        /// <summary>
        /// Register HttpClient factory and configure named clients
        /// </summary>
        ...
        /// </summary>
        builder.Services.AddScoped<ServerMCPService>();
